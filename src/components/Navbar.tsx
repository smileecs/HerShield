    ...
    <header className="sticky top-0 z-40 w-full bg-white/90 backdrop-blur-md border-b border-slate-200/80 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-teal-700 via-teal-600 to-emerald-600 flex items-center justify-center text-white shadow-md shadow-teal-700/20 group-hover:shadow-teal-700/30 transition-shadow">
              <Shield className="w-5 h-5 fill-emerald-200 stroke-[2.2]" />
            </div>
            <div>
              <span className="font-extrabold text-lg tracking-tight text-slate-900">
                SafeRoute<span className="text-teal-700 font-bold">Circle</span>
              </span>
              <span className="block text-[10px] font-semibold tracking-wider text-teal-700 uppercase -mt-1">
            ...
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  {link.badge && (
                    <span className="ml-1 px-1.5 py-0.5 text-[10px] font-extrabold uppercase bg-emerald-500 text-white rounded-full animate-pulse">
                      {link.badge}
                    </span>
                  )}
                </button>
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2.5 p-1.5 pl-3 rounded-2xl hover:bg-slate-100 transition-colors border border-slate-200/60"
                >
                  ...
                  <img
                    ...
                    alt={user.name}
                    className="w-8 h-8 rounded-xl object-cover ring-2 ring-teal-600/30"
                  />
                </button>
                ...
                {userDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl shadow-xl border border-slate-200 py-1.5 z-50 animate-scale-in">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-teal-50 hover:text-teal-800 transition-colors text-left"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-rose-600 hover:bg-rose-50 transition-colors text-left border-t border-slate-100"
                    >
              ...
              <button
                onClick={onOpenAuth}
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-teal-700 text-white hover:bg-teal-800 shadow-md shadow-teal-700/20 active:scale-95 transition-all"
              >
